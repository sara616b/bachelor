...
from user.views.api import (GetAllUsersApi, GetUserApi, GetPermissionsApi, CreateUserApi)
...
urlpatterns = [
    ...
    path('api/permissions/', GetPermissionsApi.as_view(), name='GetPermissionsApi'),
